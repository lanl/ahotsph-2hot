...
#include <sys/types.h>
#include <unistd.h>
#if defined(__SUN4__) || defined(__SUN5__) || defined(__linux__)
...
int MPI_Abort(MPI_Comm comm, int errorcode) { Error("MPI_Abort, errorcode=%d\n", errorcode); }
...
int MPI_Comm_free(MPI_Comm *commp) { return MPI_SUCCESS; }


/* These Type functions are not really implemented */

int MPI_Type_contiguous(int len, MPI_Datatype type, MPI_Datatype *ptr) { return MPI_SUCCESS; }

int MPI_Type_commit(MPI_Datatype *ptr) { return MPI_SUCCESS; }
